...
This ROS package is distributed from the standalone `autonav_sim` repo. It
expects the AutoNav robot packages to be present in the same built and sourced
colcon workspace; it does not vendor Nav2 params, the robot URDF, behavior
trees, custom plugins, or detection packages.
